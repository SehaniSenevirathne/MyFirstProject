		...
		<div class="col-sm-10  my-col3 ">
                    ...
                    <form style="text-align:center" action="login" method="post">
                        <div class="input-group mb-3">
                          ...
                          <input type="text" class="form-control" placeholder="username" id="input2" name="username" required>
                        </div>
                            ...
                            <div class="input-group mb-3">
                              ...
                              <input type="password" class="form-control" placeholder="password" id="input2" name="password" required>
                            </div>
