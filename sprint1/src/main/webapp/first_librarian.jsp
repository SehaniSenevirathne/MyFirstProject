    ...
    <div class="content_resize">
                         ...
                         <form action="search1" method="post">
                                        <div class="input-group mb-3">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text" id="search" >Search Books</span>
                                                </div>
                                            <input type="text" class="form-control" name="search" placeholder="Enter book title or author name" id="search" required>&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;
      ...
      <div class="sidebar">
        <div class="gadget">
          ...
          <ul class="sb_menu">
            <li><a href="#">Home</a></li>
            <li><a href="register_librarian.jsp">Add librarian</a></li>
			<li><a href="adminMemberCart.jsp">Borrowed book</a></li>
            <li><a href="adminMemberBorrowSearch.jsp">Returned Book</a></li>
