...
import com.service.UpdateBorrowTable;
import com.service.UpdateCartTable;
import com.service.UserBorrow;
import com.service.ViewCartTable;
...
public ModelAndView searchCart(HttpServletRequest request,HttpServletResponse respond) throws ClassNotFoundException, SQLException
{
	String search = request.getParameter("search");
	

	ViewCartTable se = new ViewCartTable();
	ArrayList list = se.searchCart(search);
	
	
	System.out.println(search);
	
	ModelAndView mv = new ModelAndView();
	mv.setViewName("adminMemberCartTable.jsp");
	mv.addObject("result",list);
...
public ModelAndView searchBorrow(HttpServletRequest request,HttpServletResponse respond) throws ClassNotFoundException, SQLException
{
	String search = request.getParameter("search");
	

	UserBorrow se = new UserBorrow();
	ArrayList list = se.searchBorrow(search);
	
	
	System.out.println(search);
	
	ModelAndView mv = new ModelAndView();
	mv.setViewName("adminMemberBorrowTable.jsp");
	mv.addObject("result",list);
	System.out.println(list);
	return mv;
}
//borrow
@RequestMapping("/updateCartTable")
public ModelAndView updateCartTable(HttpServletRequest request,HttpServletResponse respond) throws ClassNotFoundException, SQLException
{
	int id = Integer.parseInt(request.getParameter("id"));
	

	UpdateCartTable se = new UpdateCartTable();
	se.updateCart(id);
	...
	ModelAndView mv = new ModelAndView();
	mv.setViewName("adminMemberCart.jsp");
	
	return mv;
}
//return
@RequestMapping("/updateBorrowTable")
public ModelAndView updateBorrowTable(HttpServletRequest request,HttpServletResponse respond) throws ClassNotFoundException, SQLException
{
	int id = Integer.parseInt(request.getParameter("id"));
	

	UpdateBorrowTable br = new UpdateBorrowTable();
	br.updateBorrow(id);
	...
	ModelAndView mv = new ModelAndView();
	mv.setViewName("adminMemberBorrowSearch.jsp");
