      ...
      <div class="mainbar">
		...
		<div class="col-sm-10  my-col3 ">
                    ...
                    <table class="table">
                        <tr>
                            <td>
                    <form style="text-align:center" action="returnBook" method="post">
                        <div class="input-group mb-3">
                          <div class="input-group-prepend">
                            <span class="input-group-text" id="input1" >Full Name</span>
                          </div>
                          <input type="text" class="form-control" placeholder="fullname" id="input1" name="fullname">
                        </div>
                      
                            <div class="input-group mb-3">
                              <div class="input-group-prepend">
                                <span class="input-group-text"  id="input2">Address</span>
                              </div>
                              <input type="text" class="form-control" placeholder="address" id="input2" name="address">
                            </div>
							<div class="input-group mb-3">
                              <div class="input-group-prepend">
                                <span class="input-group-text"  id="input3">Book ID</span>
                              </div>
                              <input type="text" class="form-control" placeholder="bookid" id="input3" name="bookid">
                            </div>
							<div class="input-group mb-3">
                              <div class="input-group-prepend">
                                <span class="input-group-text"  id="input4">Book Name</span>
                              </div>
                              <input type="text" class="form-control" placeholder="bookname1" id="input4" name="bookname1">
                              <button type="submit" class="btn btn-outline-secondary" id="deletebutton3">Delete</button>
                            </div>
                            <div class="input-group mb-3">
                              <div class="input-group-prepend">
                                <span class="input-group-text"  id="input5">Book Name</span>
                              </div>
                              <input type="text" class="form-control" placeholder="bookname2" id="input5" name="bookname2">
                              <button type="submit" class="btn btn-outline-secondary" id="deletebutton2">Delete</button>
                            </div>    
                            <div class="input-group mb-3">
                              <div class="input-group-prepend">
                                <span class="input-group-text"  id="input6">Book Name</span>
                              </div>
                              <input type="text" class="form-control" placeholder="bookname3" id="input6" name="bookname3">
                              <button type="submit" class="btn btn-outline-secondary" id="deletebutton1">Delete</button>
                            </div>    
                              </form>
                            </td>
                            </tr>
